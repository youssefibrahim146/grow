...
class _ChatScreenState extends State<ChatScreen> {
  ...
  final String apiUrl = "https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash:generateContent?key=AIzaSyC3EUR7CKwneUPrsxt7HkF778ttq4yM5ik";
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title:  Text('Chatbot',style: TextStyle(color: AppColors.darkGoldColor),)),
      body: Column(
        children: [
          Expanded(
